...
namespace SmartExtends.FileIO
{
    ...
    public static partial class Log
    {
        ...
        /// <param name="fileMode">信息追加方式</param>
        /// <returns>是否执行成功</returns>
        public static bool Writer(HttpRequest httpRequest, string filePath, string fileName, FileMode fileMode)
        {
        ...
        /// <param name="fileMode">信息追加方式</param>
        /// <returns>是否执行成功</returns>
        public static bool Writer(HttpContext httpContext, string filePath, string fileName, FileMode fileMode)
        {
