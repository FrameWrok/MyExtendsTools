...
namespace System.Data
{
    ...
    /// 操作数据库类
    /// </summary>
    public static partial class FrameDataBase
    {
        ...
        public static List<DbParameter> GetParameters(object item, DataBaseType smartDataBaseType)
        {
            return GetParameters(GetColumnDic(item, FrameMappingType.PropertyPublic), smartDataBaseType);
        }
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>Parameter参数列表</returns>
        public static List<DbParameter> GetParameters(Dictionary<string, object> list, DataBaseType smartDataBaseType)
        {
        ...
        /// <returns>Parameter参数列表</returns>
        public static List<DbParameter> GetParametersByUserAttribute<TAttribute>(object item, DataBaseType smartDataBaseType, string mapingPropertyName) where TAttribute : Attribute
        {
    ...
    public static partial class FrameDataBase
    {
        ...
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, DataSet dataSet, List<DbParameter> listParameter, DataBaseType smartDataBaseType, string tableName)
        {
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <param name="tableName">填充的表名称</param>
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, DataSet dataSet, DataBaseType smartDataBaseType, string tableName)
        {
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <param name="tableName">填充的表名称</param>        
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, DataSet dataSet, object item, FrameMappingType smartMappingType, DataBaseType smartDataBaseType, string tableName)
        {
        ...
        /// <param name="listParameter">参数列表</param>
        /// <param name="tableName">填充的表名称</param>
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, ref DataTable dataTable, DataBaseType smartDataBaseType, List<DbParameter> listParameter, string tableName)
        {
            DbProviderFactory dbFactory = GetDbProviderFactoryByDataBaseType(smartDataBaseType);
            DbConnection dbConnection = dbFactory.CreateConnection();
            dbConnection.ConnectionString = connectionString;
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <param name="tableName">填充的表名称</param>
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, ref DataTable dataTable, DataBaseType smartDataBaseType, string tableName)
        {
        ...
        /// <param name="smartMappingType">映射方式</param>
        /// <param name="tableName">填充的表名称</param>
        public static void Fill(string connectionString, string sqlSentence, CommandType commandType, ref DataTable dataTable, DataBaseType smartDataBaseType, object item, FrameMappingType smartMappingType, string tableName)
        {
            List<DbParameter> listParameter = GetParameters(item, smartDataBaseType, smartMappingType);
        ...
        public static int ExecuteNonQuery(string connectionString, string sqlSentence, CommandType commandType, List<DbParameter> listParameter, DataBaseType smartDataBaseType)
        {
            DbProviderFactory dbProviderFactory = GetDbProviderFactoryByDataBaseType(smartDataBaseType);
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>返回影响的行数</returns>
        public static int ExecuteNonQuery(string connectionString, string sqlSentence, CommandType commandType, DataBaseType smartDataBaseType)
        {
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>返回影响的行数</returns>
        public static int ExecuteNonQuery(string connectionString, string sqlSentence, CommandType commandType, object item, FrameMappingType smartMappingType, DataBaseType smartDataBaseType)
        {
        ...
        public static DbDataReader ExecuteReader(string connectionString, string sqlSentence, CommandType commandType, List<DbParameter> listParameter, DataBaseType smartDataBaseType)
        {
            DbProviderFactory dbProviderFactory = GetDbProviderFactoryByDataBaseType(smartDataBaseType);
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>从数据源读取行的只进流</returns>
        public static DbDataReader ExecuteReader(string connectionString, string sqlSentence, CommandType commandType, DataBaseType smartDataBaseType)
        {
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>从数据源读取行的只进流</returns>
        public static DbDataReader ExecuteReader(string connectionString, string sqlSentence, CommandType commandType, object item, FrameMappingType smartMappingType, DataBaseType smartDataBaseType)
        {
            List<DbParameter> listDbParameter = GetParameters(item, smartDataBaseType, smartMappingType);
        ...
        public static object ExecuteScalar(string connectionString, string sqlSentence, CommandType commandType, List<DbParameter> listParameter, DataBaseType smartDataBaseType)
        {
            object result = null;
            DbProviderFactory dbProviderFactory = GetDbProviderFactoryByDataBaseType(smartDataBaseType);
            using (DbConnection dbConnection = dbProviderFactory.CreateConnection())
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <returns>返回的结果集中第一行的第一列</returns>
        public static object ExecuteScalar(string connectionString, string sqlSentence, CommandType commandType, object item, FrameMappingType smartMappingType, DataBaseType smartDataBaseType)
        {
            List<DbParameter> listDbParameter = GetParameters(item, smartDataBaseType, smartMappingType);
        ...
        public static void ExecuteNonQueryUseTransaction(string connectionString, Dictionary<string, List<DbParameter>> sqlDic, DataBaseType smartDataBaseType, bool useTransaction)
        {
            DbProviderFactory dbProviderFactory = GetDbProviderFactoryByDataBaseType(smartDataBaseType);
            using (DbConnection dbConnection = dbProviderFactory.CreateConnection())
            {
        ...
        /// <param name="smartDataBaseType">数据库类型</param>
        /// <param name="useTransaction">是否开启事务</param>
        public static void ExecuteNonQueryUseTransaction(string connectionString, Dictionary<string, Dictionary<object, FrameMappingType>> sqlDic, DataBaseType smartDataBaseType, bool useTransaction)
        {
    ...
    public static partial class FrameDataBase
    {
        ...
        public static string CreateParameterName(string columnName, DataBaseType smartDataBaseType)
        {
