...
namespace FrameWork.Core.Extends
{
    ...
    public static partial class FrameFileInfoExtends
    {
        ...
        {
            FileIO.FileCompress.Compress(fileInfo.FullName, outputPath, passWord);
        }
        ...
        {
            FileIO.FileCompress.Compress(fileInfo.FullName, outputPath);
        }
        ...
        {
            FileIO.FileCompress.DeCompress(fileInfo.FullName, outputPath, 1024);
        }
    }
}
