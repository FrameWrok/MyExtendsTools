...
public static partial class FrameStringExtends
{
    ...
    /// <returns></returns>
    public static string ToPascalName(this string input)
    {
        if (input.IsNullOrEmptyOrBlank())
            return "";
        if (input.Length > 1)
            return input.Left(1).ToUpper() + input.Right(input.Length - 1);
    ...
    /// <param name="input"></param>
    /// <returns></returns>
    public static string ToCamelName(this string input)
    {
        if (input.IsNullOrEmptyOrBlank())
            return "";
        if (input.Length > 1)
            return input.Left(1).ToLower() + input.Right(input.Length - 1);
...
public static partial class FrameHttpExtends
{
    /// <summary>
